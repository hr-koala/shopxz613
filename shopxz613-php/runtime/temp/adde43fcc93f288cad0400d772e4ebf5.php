<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/web/rainbow/agent\index.html";i:1548744524;s:72:"D:\PHPTutorial\WWW\shopxz613-php\template\web\rainbow\public\header.html";i:1548744524;s:72:"D:\PHPTutorial\WWW\shopxz613-php\template\web\rainbow\public\footer.html";i:1548744524;}*/ ?>
...
<div class="container">
    <div class="top">
        <div class="top-left">
            ...
            <div class="name-info">
                ...
                <div class="tel-box">
                    <div class="tel"><?php echo substr_replace($user_info[mobile], '****', 3, 4); ?></div>
                    <div class="referrer">推荐人：<?php echo $referee; ?></div>
                </div>
    ...
    <div class="yongjin">
        <div class="yongjin-lf">
            <div class="num"><span><?php echo $user_info['goods_income']; ?></span></div>
    ...
    <div class="box">
        <a class="income" href="<?php echo U('cosmetology/Index/index',['myShop'=>$user_info['user_id']]); ?>">
    ...
    <div class="box">
        ...
        <a class="income" href="<?php echo U('cosmetology/Agent/reward_details'); ?>">
            <div class="income-lf">
