<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/web/rainbow/mine\index.html";i:1548744523;s:72:"D:\PHPTutorial\WWW\shopxz613-php\template\web\rainbow\public\header.html";i:1548744524;s:72:"D:\PHPTutorial\WWW\shopxz613-php\template\web\rainbow\public\footer.html";i:1548744524;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="top">
            ...
            <div class="nicename">
                ...
                <div class="proxy">
                    ...
                    <div class="proxy-txt"><?php if($level != ''): ?><?php echo $level['level_name']; else: ?>普通会员<?php endif; ?></div>
                </div>
                <div class="mobile"><?php echo substr_replace($user_info[mobile], '****', 3, 4); ?></div>
            </div>
            ...
            <div class="other">
            	<ul>
	                ...
	                <li>
                        ...
                        <li>
                            <a href="<?php echo U('cosmetology/Mine/application_agent'); ?>" class="flex-row" title="">
                                <div class="icon i2"></div>
                                <div class="right flex-row">
                                    <div class="name">申请代理</div>
                                    <div class="jt-r"></div>
                                </div>
                            </a>
                        </li>
                    
                    <?php if($level == null): endif; ?>
	            </ul>
	        </div>
                <div class="box">
                    <a class="income" href="<?php echo U('cosmetology/Mine/cloud_inventory'); ?>">
                    ...
                    <a class="income" href="<?php echo U('cosmetology/Mine/replenishment_center'); ?>">
                        <div class="income-lf">
                ...
                <div class="box">
                    <a class="income" href="<?php echo U('cosmetology/Mine/agent_upgrade'); ?>">
                        <div class="income-lf">
                    ...
                    <a class="income" href="<?php echo U('cosmetology/Mine/levelDescription'); ?>">
                        <div class="income-lf">
