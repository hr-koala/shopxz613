<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/user\index.html";i:1547087031;s:71:"E:\phpStudy\WWW\meirong-php11\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="nickname" axis="col4" class="">
                            <div style="text-align: center; width: 70px;" class="">会员昵称</div>
                        </th>
                        <th align="left" abbr="registered_name" axis="col4" class="">
                            <div style="text-align: center; width: 70px;" class="">真实姓名</div>
                        </th>
                        <th align="left" abbr="id_card" axis="col4" class="">
                            <div style="text-align: center; width: 130px;" class="">身份证号</div>
                        </th>
                       ...
                       <th align="center" axis="col6" class="">
                        ...
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">报单币余额</div>
                        </th>
                        <th align="center" abbr="reg_time" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">被报单用户</div>
                        </th>
                        <th align="center" abbr="reg_time" axis="col6" class="">
