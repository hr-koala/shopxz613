...
return [
    ...
    // 默认模块名
    'default_module'         => 'cosmetology',//home
    // 禁止访问模块
...
*/ 
    ...
    //order_status = 1; shipping_status = 0; pay_status = 1;
    //用户消息类型
    ...
    'PURCHASECOMPLETED' => ' AND pay_status=6 AND shipping_status =1 AND order_status=1 ', //订单查询状态 进货完成,
    ...
    //1-8层身份
    'gross_purchases_name'=>[
        '1'=>'superior_gross_purchases',
        '2'=>'two_gross_purchases',
        '3'=>'three_gross_purchases',
        '4'=>'four_gross_purchases',
        '5'=>'five_gross_purchases',
        '6'=>'six_gross_purchases',
        '7'=>'seven_gross_purchases',
        '8'=>'eight_gross_purchases',
    ],

    //商品价格字段
    'goods_grade_price'=>[
        '1'  => 'shop_price',//普通会员价格
        '2'  => 'distributor_price',//经销商购买价格
        '10' => 'lian_price',//联创购买价格
        '11' => 'shopkeeper_price',//店主购买价格
        '12' => 'market_generation_price',//市代购买价格
        '13' => 'provincial_generation_price',//省代购买价格
    ],
