<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods\goodsList.html";i:1544667853;s:71:"E:\phpStudy\WWW\meirong-php11\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
    ...
    <ul>
      <li style="color: #ef6268;">商品名称为红色属于升级代理商品.</li>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 70px;" class="" onClick="sort('is_on_sale');">上/下架</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
