<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/view/goods\ajaxGoodsList.html";i:1544668147;}*/ ?>
<table>
       <tbody>
            <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
			 ...
			 <td class="handle" >
                ...
                <td align="center" axis="col0">
                  <div style="text-align: left; width: 300px;"><?php if($list[is_virtual] == 1): ?><span class="type-virtual" title="虚拟兑换商品">虚拟</span><?php endif; ?><span  style="color: <?php echo $list['is_agent']=='1'?'red':'#555'; ?>;"><?php echo getSubstr($list['goods_name'],0,33); ?></span></div>
                </td>
                <td align="center" axis="col0">
                ...
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 70px;">
                    <?php if($list[is_on_sale] == 1): ?>
                      ...
                      <?php else: if(($list[cat_id] == 0) OR ($list[shop_price] == 0) OR ($list[market_price] == 0)): ?>
                        <a class="no" href="<?php echo U('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'])); ?>"><i class="fa fa-ban"></i>完善商品</a>
                      <?php else: ?>
