...
class GoodsLogic extends Model
{
    ...
    public function getSpecInput($goods_id, $spec_arr)
    {
        ...
        foreach ($spec_arr_sort as $key =>$val)
        {
         ...
         $keySpecGoodsPrice = M('SpecGoodsPrice')->where('goods_id = '.$goods_id)->getField('key,key_name,price,store_count,bar_code,sku,market_price,cost_price,commission,distributor_price,lian_price,shopkeeper_price,market_generation_price,provincial_generation_price');//规格项
       ...
       $str .="<td><b>普通会员购买价</b><span style='color: red'>&nbsp;(必填)</span></td>
                <td><b>经销商购买价格</b><span style='color: red'>&nbsp;(必填)</span></td>
                <td><b>联创购买价格</b><span style='color: red'>&nbsp;(必填)</span></td>
                <td><b>店主购买价格</b><span style='color: red'>&nbsp;(必填)</span></td>
                <td><b>市代购买价格</b><span style='color: red'>&nbsp;(必填)</span></td>
                <td><b>省代购买价格</b><span style='color: red'>&nbsp;(必填)</span></td>
               <td><b>市场价</b><span style='color: red'>&nbsp;(必填)</span></td>
               <td><b>成本价</b></td>
               <td><b>库存</b><span style='color: red'>&nbsp;(必填)</span></td>
               <td><b>操作</b></td>
             </tr>";
        if(count($spec_arr2) > 0){
            $str_fill .='<td><input id="item_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>
                ...
                <td><input id="item_distributor_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>

                <td><input id="item_lian_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>

                <td><input id="item_shopkeeper_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>

                <td><input id="item_market_generation_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>

                <td><input id="item_provincial_generation_price" value="0" onkeyup="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)" onpaste="this.value=this.value.replace(/[^\d.]/g,&quot;&quot;)"></td>
        ...
        /*$str .="<td><b>购买价</b><span style='color: red'>&nbsp;(必填)</span></td>
               <td><b>市场价</b><span style='color: red'>&nbsp;(必填)</span></td>
               <td><b>成本价</b></td>
               <td><b>佣金</b></td>
               <td><b>库存</b><span style='color: red'>&nbsp;(必填)</span></td>
       ...
       foreach ($spec_arr2 as $k => $v) 
       {
            ...
            $keySpecGoodsPrice[$item_key][distributor_price] ? false : $keySpecGoodsPrice[$item_key][distributor_price] = 0; // 价格默认为0
            $keySpecGoodsPrice[$item_key][lian_price] ? false : $keySpecGoodsPrice[$item_key][lian_price] = 0; // 价格默认为0
            $keySpecGoodsPrice[$item_key][shopkeeper_price] ? false : $keySpecGoodsPrice[$item_key][shopkeeper_price] = 0; // 价格默认为0
            $keySpecGoodsPrice[$item_key][market_generation_price] ? false : $keySpecGoodsPrice[$item_key][market_generation_price] = 0; // 价格默认为0
            $keySpecGoodsPrice[$item_key][provincial_generation_price] ? false : $keySpecGoodsPrice[$item_key][provincial_generation_price] = 0; // 价格默认为0
            ...
            $str .="<td><input name='item[$item_key][distributor_price]' value='{$keySpecGoodsPrice[$item_key][distributor_price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";

            $str .="<td><input name='item[$item_key][lian_price]' value='{$keySpecGoodsPrice[$item_key][lian_price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";

            $str .="<td><input name='item[$item_key][shopkeeper_price]' value='{$keySpecGoodsPrice[$item_key][shopkeeper_price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";

            $str .="<td><input name='item[$item_key][market_generation_price]' value='{$keySpecGoodsPrice[$item_key][market_generation_price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";

            $str .="<td><input name='item[$item_key][provincial_generation_price]' value='{$keySpecGoodsPrice[$item_key][provincial_generation_price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";
        ...
        if ($goods_item) {
            ...
            foreach ($goods_item as $k => $v) {
                ...
                $data = [
                    ...
                    'lian_price' => $v['lian_price'],
                    'shopkeeper_price' => $v['shopkeeper_price'],
                    'market_generation_price' => $v['market_generation_price'],
                    'provincial_generation_price' => $v['provincial_generation_price'],
                ];
