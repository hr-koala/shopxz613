<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./template/web/rainbow/user\register.html";i:1547466247;s:72:"D:\PHPTutorial\WWW\shopxz613-php\template\web\rainbow\public\header.html";i:1547189899;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container" id="all">
        <div class="main">
            ...
            <div class="inp-box flex-row" v-show="isHyCodeFlag">
                <div class="left">
                    <input type="text" v-model="hycodeValue" name="" id="hycode" value="<?php echo $code==''?'':$code; ?>" placeholder="">
                </div>
            </div>
            <div class="tx flex-row">
                <a href="<?php echo U('cosmetology/User/login'); ?>"><span>已有账号？</span>立即登陆</a>
            </div>
        </div>
        <div class="btn-box">
...
$(function(){
    ...
    $('.btn-submit').on('click', function(){
        ...
        if(flag){
            ...
            $.post("<?php echo U('cosmetology/User/register'); ?>", {username:username,useridcard:useridcard,userphone:userphone,yzcode:yzcode,psw:psw,againPsw:againPsw,code:code},function(datas){
