	     ...
	     */
         ...
         //        array('name' => '素材管理', 'act'=>'materials', 'op'=>'Wechat'),
			...
			array('name' => '统计','child' => array(
					array('name' => '月入款总额', 'act'=>'monthly_report', 'op'=>'Report'),
					array('name' => '会员每月业绩', 'act'=>'monthly_bonus', 'op'=>'Report'),
