<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/report\finance.html";i:1530846802;s:71:"E:\phpStudy\WWW\meirong-php11\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $vo['order_prom_amount']; ?></div>
                            </td>
							<td align="center" class="">
